        ...
        <div className="container px-4 mx-auto sm:px-6 lg:px-8">
          <div className="relative flex items-center justify-between">
            ...
            <div className="hidden md:flex md:items-center md:justify-center md:space-x-10 md:absolute md:inset-y-0 md:left-1/2 md:-translate-x-1/2 lg:space-x-16">
              <a
                href="#features"
                className="text-base font-medium text-gray-600 transition-all duration-200 hover:text-primary"
              >
                {" "}
                Features{" "}
              </a>
        ...
        <div className="relative px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-y-4 lg:items-center lg:grid-cols-2 xl:grid-cols-2">
            <div className="text-center xl:col-span-1 lg:text-left md:px-16 lg:px-0 xl:pr-20">
              <h1 className="text-4xl font-semibold leading-snug text-gray-900 tracking-tight sm:text-5xl sm:leading-tight lg:text-6xl lg:leading-tight">
                Manage Buyer Data Without Chaos.
              </h1>
              <p className="mt-2 text-lg text-gray-600 sm:mt-6">
                Upload, manage, and explore buyer datasets with powerful search,
                pagination, and secure access control built for operational
                teams.
              </p>
              ...
              <div className="mt-8 sm:mt-16">
                ...
                <blockquote className="mt-6">
                  ...
                  <p className="mt-3 text-base leading-7 text-gray-600">
                    “We replaced scattered spreadsheets with this portal in
                    under a day. Uploading buyer files is instant, search is
                    fast even with thousands of records, and access control
                    finally solved our data duplication issues.”
                  </p>
                </blockquote>
            ...
            <div className="xl:col-span-1">
              <img
                ...
                src="/vectorized-Gemini_Generated_Image_reavugreavugreav.svg"
