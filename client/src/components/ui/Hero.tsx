                ...
                <div className="relative px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 gap-y-4 lg:items-center lg:grid-cols-2 xl:grid-cols-2">
                        <div className="text-center xl:col-span-1 lg:text-left md:px-16 lg:px-0 xl:pr-20">
                            <h1 className="text-4xl font-semibold leading-snug text-gray-900 tracking-tight sm:text-5xl sm:leading-tight lg:text-6xl lg:leading-tight">Manage Buyer Data Without Chaos.</h1>
                            <p className="mt-2 text-lg text-gray-600 sm:mt-6">Upload, manage, and explore buyer datasets with powerful search, pagination, and secure access control built for operational teams.</p>

                            <Link to="/register" title="" className="inline-flex px-8 py-4 mt-8 text-lg font-bold text-white transition-all duration-200 bg-gray-900 border border-transparent rounded sm:mt-10 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900" role="button">
                                Get Started
                            </Link>
                            ...
                            <div className="mt-8 sm:mt-16">
                                ...
                                <blockquote className="mt-6">
                                    <p className="text-lg font-bold text-gray-900">Very useful!</p>
                                    <p className="mt-3 text-base leading-7 text-gray-600">“We replaced scattered spreadsheets with this portal in under a day. Uploading buyer files is instant, search is fast even with thousands of records, and access control finally solved our data duplication issues.”
                                    </p>
                                </blockquote>
                                ...
                                <div className="flex items-center justify-center mt-3 lg:justify-start">
                                    ...
                                    <p className="ml-2 text-base font-bold text-gray-900">Denny Jones</p>
                                </div>
                            </div>
                        </div>

                        <div className="xl:col-span-1">
                            <img className="w-full mx-auto" src="/vectorized-Gemini_Generated_Image_reavugreavugreav.svg" alt="Hero Illustration" />
                        </div>
                    </div>
                </div>
            </section>
